...
class Starter:
    ...
    def __init__(self, key, state, county, tract=None, acsyear=2016):
        ...
        self.h_acs_cat = cat.categorize(h_acs, {
            ...
            ("hh_education_of_head", "highschool or less"): "B25013_003E + B25013_004E + B25013_008E + B25013_009E",
            ("hh_education_of_head", "college or associate"): "B25013_005E + B25013_010E",
            ("hh_education_of_head", "bachelor or more"): "B25013_006E + B25013_011E",
    ...
    def get_household_joint_dist_for_geography(self, ind):
        ...
        h_pums['hispanic_head'] = p_pums[p_pums.RELP == 0].groupby(
            'serialno').HISP.max()
        h_pums['education_head'] = p_pums[p_pums.RELP == 0].groupby(
            'serialno').SCHL.max()
        ...
        def education_of_head(r):
            if r.education_head >= 21:
                return "bachelor or more"
            elif (r.education_head >= 17) & (r.education_head <= 20):
                return "college or associate"
            else:
                return "highschool or less"
        ...
        h_pums, jd_households = cat.joint_distribution(
            ...
            {"hh_cars": cars_cat,
             ...
             "hh_education_of_head": education_of_head}
        )
