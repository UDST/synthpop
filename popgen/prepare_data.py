...
def prepare_data(data_dir, hh_sample_file, per_sample_file, hh_marginals_file, per_marginals_file):
    ...
    for val in range(len(vals)):
        ...
        hhid_var['group_id'] = hhid_var['group_id'] + hhid_var[str(val)+'_str']
    ...
    return {'matrix':matrix, 'sparse_matrix':sparse_matrix, 'sparse_matrix1':sparse_matrix1, 'index_matrix':index_matrix, 'housing_synthetic_data':housing_synthetic_data, 'person_synthetic_data':person_synthetic_data, 'hhld_0_joint_dist':hhld_0_joint_dist, 'person_0_joint_dist':person_0_joint_dist}
