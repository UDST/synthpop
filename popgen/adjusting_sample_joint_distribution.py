...
def hhld_0_joint_dist(hh_sample, hh_var_list):
    ...
    agg['frequency'] = 'sum'
    hhld_0_joint_dist = hhld_0_joint_dist.groupby(
        'hhld_uniqueid', as_index=False).agg(agg)
...
def person_0_joint_dist(per_sample, per_vars):
    ...
    agg['frequency'] = 'sum'
    person_0_joint_dist = person_0_joint_dist.groupby(
        'person_uniqueid', as_index=False).agg(agg)
